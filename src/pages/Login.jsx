  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <button
          onClick={() => {
            login('lalith@indy.lcps.org', 'password');
            navigate('/dashboard');
          }}
          className="w-full rounded-lg border border-warm-200 py-2.5 text-sm font-medium text-warm-700 hover:bg-warm-100 dark:border-warm-700 dark:text-warm-300 dark:hover:bg-warm-800"
        >
          Demo login (Advisor)
        </button>
