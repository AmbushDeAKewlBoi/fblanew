        ...
        >
          <div className="card-surface p-8 sm:p-10">
            ...
            <motion.button
              ...
              disabled={submitting}
              className="flex w-full items-center justify-center gap-3 border border-[var(--atlas-border)] bg-[var(--atlas-elev)] px-6 py-3.5 text-sm font-semibold text-[var(--atlas-fg)] transition-colors hover:border-[var(--atlas-accent)] disabled:cursor-wait disabled:opacity-60"
            >
